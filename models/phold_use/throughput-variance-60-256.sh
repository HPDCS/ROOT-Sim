...
time timeout 10m ./phold --wt 40 --lp $lp --gvt $gvt --wallclock-time 1000000 --powercap 888 >> results-throughput-variance-60-256/$gvt-gvt-$lp-lp-$cap-cap-$mode-mode-$pstate-pstate-$threads-threads-$repeat
