 ...
 * 	Care to avoid side effects in the arguments because they may be evaluated more than once
 */
#define bitmap_set(bitmap, bit_index) (B_SET_BIT(UNION_CAST((bitmap), B_BLOCK_TYPE*), ((unsigned)(bit_index))))
 ...
 * 	Care to avoid side effects in the arguments because they may be evaluated more than once
 */
#define bitmap_reset(bitmap, bit_index) (B_RESET_BIT(UNION_CAST((bitmap), B_BLOCK_TYPE*), ((unsigned)(bit_index))))
 ...
 * 	Care to avoid side effects in the arguments because they may be evaluated more than once
 */
#define bitmap_check(bitmap, bit_index) (B_CHECK_BIT(UNION_CAST((bitmap), B_BLOCK_TYPE*), ((unsigned)(bit_index))) != 0)
...
#define bitmap_count_reset(bitmap, bitmap_size) ({									\
		...
		B_BLOCK_TYPE __cur_block, *__block_b = UNION_CAST((bitmap), B_BLOCK_TYPE*);	\
