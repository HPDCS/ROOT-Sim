...
enum stat_msg_t {
	...
	STAT_COMMITTED_APPROX,  /** total number of approximated committed events */
	STAT_APPROX_PHASE,  /** number of switches to approximated phase */
	STAT_PREC_PHASE, /** number of switches to precise phase */
	...
	STAT_SILENT_TIME,
	STAT_EVENT,
	STAT_EVENT_APPROX, /** total number of approximated events*/
	STAT_EVENT_TIME,
	STAT_CKPT_TIME,
	STAT_CKPT_TIME_APPROX, /** time spent in taking a checkpoint of core state metadata */
	STAT_ROLLBACK,
	STAT_ROLLBACK_APPROX, /** number of rollbacks generated by an approximated event */

	STAT_RECOVERY,
	STAT_RECOVERY_APPROX,
	STAT_RECOVERY_TIME,
	STAT_RECOVERY_TIME_APPROX,
	STAT_RESTORE_FN_TIME_APPROX,
...
struct stat_t {
	unsigned long long tot_ckpts_time_approx, tot_ckpts_time, tot_recovery_time_approx, tot_recovery_time, silent_event_time, restore_fn_time_approx;
	unsigned long long tot_rollbacks, tot_recoveries, tot_recoveries_approx, tot_rollbacks_approx, tot_events, tot_events_approx, silent_events, tot_ckpts, tot_ckpts_approx;

	unsigned long long tot_antimessages,
	    committed_events,
	    ckpt_mem,
	    idle_cycles,
	    memory_usage,
...
extern inline void statistics_post_data(const struct lp_struct *, enum stat_msg_t type, unsigned long long data);
...
extern unsigned computeCheckpointInterval(const struct lp_struct *, bool);
