...
enum stat_msg_t {
	...
	STAT_SILENT,
	STAT_GVT_ROUND_TIME,
	STAT_CKPT_TIME_CORE, /** time spent in taking a checkpoint of core state metadata */
	STAT_EVENT_TIME_APPROX, /** time spent in processing an approximated event */
	...
	STAT_RECOVERY_TIME_CORE, /** time spent in recovering core state metadata */
	STAT_APPROX_PHASE,  /** number of switches to approximated phase */
	STAT_PREC_PHASE, /** number of switches to precise phase */
	STAT_RESTORE_APPROX, /** time spent in RestoreApproximated */
	STAT_GET_CKPT_TIME,
	STAT_GET_EVENT_TIME,
...
extern inline void statistics_post_data(const struct lp_struct *, enum stat_msg_t type, double data);
